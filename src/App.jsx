...
function App() {
  let productData = [
    ...
    },
    {
      ...
      price: 22.3,
      description:
        "Slim-fitting style, contrast raglan long sleeve, three-button henley placket, lightweight & soft fabric for comfortable wear. And solid stitched shirts with round neck made for durability.",
      category: "men's clothing",
  ...
  return (
    <Store.Provider value={{ productData }}>
      {/* <RegistrationForm/> */}
      {/* <LoginForm/> */}
      <NavBar />
      <Advertisement />
